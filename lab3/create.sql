...
CREATE TABLE employees (
    ...
    FOREIGN KEY (fk_position_id) REFERENCES positions(id)
);
...
CREATE TABLE subscriptions (
    ...
    FOREIGN KEY (fk_status_id) REFERENCES subscription_states(id)
);
...
CREATE TABLE deliveries (
    ...
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CHECK (created_at <= updated_at),
    FOREIGN KEY (fk_subscription_id) REFERENCES subscriptions(id),
    FOREIGN KEY (fk_employee_id) REFERENCES employees(fk_user_id)
);
...
CREATE TABLE ingredients (
    ...
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CHECK (created_at <= updated_at),
    FOREIGN KEY (fk_ingredient_category_id) REFERENCES ingredients_categories(id)
);
...
CREATE TABLE ingredient_allergens (
    ...
    FOREIGN KEY (fk_allergen_id) REFERENCES allergens(id)
);
...
CREATE TABLE meals (
    ...
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CHECK (created_at <= updated_at),
    FOREIGN KEY (fk_meal_category_id) REFERENCES meal_categories(id),
    FOREIGN KEY (fk_diet_type_id) REFERENCES diet_types(id)
);
